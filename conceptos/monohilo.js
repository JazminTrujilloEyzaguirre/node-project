...
// SetInterval me permtie ejecutar una función cada n cantidad de tiempo, 
// por lo que quiere que recibe como argumentos: Función a ejecutarse, intervalo de tiempo.
...
setInterval(function(){console.log('Voy a contar hasta infinito, detén mi ejecución o consumo tu memoria'),1000}); 
...
// Al ser monohilo el peligro recae en que si el código se ejectua y 
// no tenemos cuidado el no asignar una variable de manera correcta me puede arrojar un error.
